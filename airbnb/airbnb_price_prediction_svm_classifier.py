...
def sweep_hyperparameter_space_and_plot_complexity_curves(clf, features, labels, problem_name, plot_dir):
    parameter_search_space = [[{'kernel': 'linear'}, {'kernel': 'poly'}, {'kernel': 'rbf'}, {'kernel': 'sigmoid'}], [{'gamma': 'scale'}, {'gamma': 'auto'}]]
...
param_dist = {'kernel': ['linear', 'poly', 'sigmoid'], 'gamma': ['scale', 'auto']}
